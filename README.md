...
[![Watch the InteliCareer demo](docs/demo-poster.svg)](docs/demo.mp4)

> 90-second walkthrough. Click the poster above to play (`docs/demo.mp4`). The recording is generated by `tools/demo` (Playwright + ffmpeg) — regenerate it any time with `cd tools/demo && npm run demo` while both dev servers are running.
